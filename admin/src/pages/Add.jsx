...
const Add = ({token}) => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-2.5'>
      <div>
      ...
      <div className="flex flex-col sm:flex-row gap-2 w-full sm:gap-8">
        ...
        <div>
          <p className='mb-2 text-gray-600 font-semibold'>SubCategory</p>
      ...
      <div>
        <p className='mb-2 text-gray-600 font-semibold'>Product Sizes</p>
